...
class Node3D_gfn1xtb(Node):
    ...
    @staticmethod
    def en_func(node: Node3D_gfn1xtb):
        res = Node3D_gfn1xtb.run_xtb_calc(node.tdstructure)
        return res.get_energy()

    @staticmethod
    def grad_func(node: Node3D_gfn1xtb):
        res = Node3D_gfn1xtb.run_xtb_calc(node.tdstructure)
    ...
    def energy(self):
        if self._cached_energy is not None:
            ...
            return Node3D_gfn1xtb.run_xtb_calc(self.tdstructure).get_energy()
    ...
    @property
    def hessian(self: Node3D_gfn1xtb):
