# msmep
The following tutorial shows how to use the Multi Step Minimum Energy Path (MSMEP) object, as well as how to generate a minimum energy path starting with only two smiles strings. 
